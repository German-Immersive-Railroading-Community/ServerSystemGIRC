...
public class PlayerMenu extends PlayerInventory {
	...
	public PlayerMenu(Player player, Player target) {
		...
		setItem(0, createItem("Gamemode Survival", Material.IRON_SPADE), (itemstack) -> {target.setGameMode(GameMode.SURVIVAL);});
		...
		setItem(27, createItem(target.getName(), Material.REDSTONE_BLOCK));
